...
onclick="saveSuggestion('${id}','yes',${i},${j})">Yes
</label>

<label>
<input type="radio" name="${id}" value="no"
onclick="saveSuggestion('${id}','no',${i},${j})" checked>No
</label>
...
function saveSuggestion(id,value,row,col){
...
localStorage.setItem(`R${row}C${col}`,current)
...
let value=localStorage.getItem("R"+i+"C"+j) || "-"
